...
class CQueue{
     ...
     ******************************************/
    void clearRecursive(Node* aDrone);
    Node* CQueueCopyRecursive(Node* aNode);
    Node* CQueueAssignRecursive(Node* aNode);
    void printOrdersQueueRecursive(Node* aNode) const;
    void swap(Node* & aNode, Node* & bNode);
    Node* mergeLeftist(Node* aNode, Node* aHeap, prifn_t function);
    Node* mergeSkew(Node* aNode, Node* aHeap, prifn_t function);
    Node* setHelper(Node* aNode);
